...
<div class="container">
    <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach var="orderSupplier" items="${ordersSupplier}" varStatus="status">
                <tr class="info">
                    <td>
							<span class="custom-checkbox">
                    ...
                    <td class="orderSupplierId">${orderSupplier.id}</td>
                    <td>${orderSupplier.userId}</td>
                    <td>${orderSupplier.total}</td>
                    <td>
                        <a href="#editOrderModal" editOrderId="${orderSupplier.id}" class="edit editOrderBtn" data-toggle="modal"><i class="material-icons"
                                                                                                                             data-toggle="tooltip"
                                                                                                                             title="Edit">&#xE254;</i></a>
